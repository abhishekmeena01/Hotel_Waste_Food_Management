...
<head>
          ...
          <a href="logout.jsp" style="color:white;text-decoration:none">Sign Out <i class="fas fa-sign-out-alt"></i></a></li>
            ...
            <%
                  ...
                  <div class="alert alert-info text-capitalize text-center  " role="alert">
                    ...
                    %>
        			 <h3 style="color:red"><center> Fill This Form to Raise A Request</center></h3><br/><!-- comment -->
                 
                    <form action="raiseRequest" method="post" role="form" style="margin-left:20px;margin-right: 20px"><b>
  <div class="form-group row"> 
      ...
      <input type="text" class="form-control" id="name" name="name" placeholder="Name" required/>
                        ...
                        <div class="form-group row"> 
      <label for="inputEmail"class="col-sm-2 col-form-label">Enter The Email ID</label>
      <div class="col-sm-10">
      ...
      <div class="col-sm-10">
      <input type="text" class="form-control" id="email" name="phone" placeholder="Your Contact Number" pattern="^[_0-9]{1,}$" maxlength="10" minlength="10" validate required/>
      </div></div>
           <div class="form-row">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" id="inputpin" name="pin" placeholder="Enter the PinCode" pattern="^[_0-9]{1,}$" maxlength="6">
       ...
       <div class="form-row">                 
    <div class="form-group col-md-4">
      <label for="inputDonate">Which Item are you requesting For:-</label>
    ...
    <input type="text" class="form-control" id="inputAddress" name="quantity" placeholder="Enter the Amount of Item you want to Donate">
                             ...
                             <div class="form-group col-md-4">            
    <label for="inputAmount">Due Date </label>
    <input type="date" class="form-control" id="inputAddress" name="last_date" placeholder="Enter the Last Date Before which item is required">
                             </div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" id="inputAddress2" name="comments" placeholder="Enter the Description of Item Donated">
                    ...
                    <!--<form action="raiseRequest" method="post" role="form">
                        <Label>Name </label>
                        ...
                        <input type="text" id="pin" name="pin"/>
                         <Label> Which Item are you requesting for- </label>
                        <select name="donate"> 
                        ...
                        <input type="date" id="quantity" name="last_date"/>
